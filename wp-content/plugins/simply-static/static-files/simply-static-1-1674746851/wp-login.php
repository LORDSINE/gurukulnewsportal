...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.1.1" type="text/css" media="all">
	...
	<link rel="icon" href="/wp-content/uploads/2023/01/logan.jpg" sizes="32x32">
<link rel="icon" href="/wp-content/uploads/2023/01/logan.jpg" sizes="192x192">
<link rel="apple-touch-icon" href="/wp-content/uploads/2023/01/logan.jpg">
<meta name="msapplication-TileImage" content="/wp-content/uploads/2023/01/logan.jpg">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/gurukulnews/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/gurukulnews/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to गुरुकुल समाचार</a>		</p>
			</div>
...
var _wpUtilSettings = {"ajax":{"url":"\/gurukulnews\/wp-admin\/admin-ajax.php"}};
/*  */</script>
<script type="text/javascript" src="/wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">/*  */
var userProfileL10n = {"user_id":"0","nonce":"414910a024"};
/*  */</script>
